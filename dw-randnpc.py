...
def pickappearance(job):
	...
	hairList = ['fancy hair','wild hair','stylish cap','tonsure','strange hair','bald','furry hood','messy hair','braided hair','wild hair','shorn hair','battered helm','polished helmet','drab-colored hood','cropped hair','styled hair','shapeless hat']
	...
	return '%s eyes, %s, wearing %s on a %s frame' % (choice(eyeList), choice(hairList), choice(clothingList), choice(bodyList))
